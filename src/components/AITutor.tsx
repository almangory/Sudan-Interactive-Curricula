  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "welcome",
      role: 'model',
      text: `مرحباً بك يا غالي ! أنا المعلم السوداني ومساعدك لـ (${subjectName}). 💡✨\n\n سأقوم الآن بالبحث المباشر والربط الذكي من الكتب والمذكرات والمواقع التفاعلية المرفقة لدرسك لضمان أعلى مستوى من الدقة والموثوقية! اكتب سؤالك أو مشكلتك وسنقوم بالبحث عنها فوراً.`
    }
  ]);
