    ...
    grades: [
      ...
      },
      {
        ...
        subjects: [
          ...
          {
            id: "pri3-math",
            name: "الرياضيات الحسابية",
            iconName: "Calculator",
            colorClass: "bg-indigo-100 text-indigo-800 border-indigo-200",
            interactiveUrl: "https://phet.colorado.edu/sims/html/fractions-intro/latest/fractions-intro_all.html",
      ...
      },
      {
        ...
        subjects: [
          {
            id: "pri5-science",
            name: "العلوم والأكوان الطبيعية",
            iconName: "Compass",
            colorClass: "bg-cyan-100 text-cyan-800 border-cyan-200",
            interactiveUrl: "https://phet.colorado.edu/sims/html/gravity-and-orbits/latest/gravity-and-orbits_all.html",
      ...
      },
      {
        ...
        subjects: [
          ...
          {
            id: "pri6-math",
            name: "الرياضيات المتقدمة والهندسة",
            iconName: "Calculator",
